...
export default function WelcomePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAF9F6', fontFamily: 'Inter, sans-serif' }}>
      <div className="aw-container" style={{ width: '100%', margin: '0 auto', padding: '60px 24px 50px', boxSizing: 'border-box', textAlign: 'center' }}>
        ...
        <div style={{ marginBottom: 36, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          {[
            ...
            <div key={benefit} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 14, justifyContent: 'center' }}>
              <div style={{ color: '#6B8F76', fontSize: 14, marginTop: 1 }}>•</div>
              <div style={{ fontSize: 14.5, color: '#3A3A38', lineHeight: 1.4, textAlign: 'left' }}>{benefit}</div>
            </div>
          ))}
        </div>
