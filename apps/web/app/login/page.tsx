  ...
  return (
    <div style={{ minHeight: '100vh', background: '#efe6d3', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif', padding: '40px 24px' }}>
      <div style={{ width: '100%', maxWidth: 380 }}>
        <div style={{ fontFamily: 'Lora, serif', fontSize: 26, fontWeight: 700, color: '#33324a', marginBottom: 6, textAlign: 'center' }}>
          {mode === 'signup' ? 'Create your account' : 'Welcome back'}
        </div>
        <div style={{ fontSize: 14, color: '#8d8570', marginBottom: 28, textAlign: 'center' }}>
        ...
        <button
          ...
          style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: '#fbf6ec', border: '1px solid rgba(51,50,74,0.14)', borderRadius: 100, padding: '13px', fontSize: 14, fontWeight: 600, color: '#33324a', cursor: 'pointer', marginBottom: 10 }}
        >
        ...
        <button
          ...
          style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: '#33324a', border: 'none', borderRadius: 100, padding: '13px', fontSize: 14, fontWeight: 600, color: '#f3ecdc', cursor: 'pointer', marginBottom: 22 }}
        >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 22 }}>
          ...
          <div style={{ fontSize: 12, color: '#8d8570' }}>or with email</div>
          <div style={{ flex: 1, height: 1, background: 'rgba(51,50,74,0.15)' }} />
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            required
            style={{ width: '100%', background: '#fbf6ec', border: '1px solid rgba(51,50,74,0.14)', borderRadius: 10, padding: '12px 14px', fontSize: 14, color: '#3f3b2e', marginBottom: 14, boxSizing: 'border-box' }}
          />
          ...
          <input
            ...
            required
            minLength={6}
            style={{ width: '100%', background: '#fbf6ec', border: '1px solid rgba(51,50,74,0.14)', borderRadius: 10, padding: '12px 14px', fontSize: 14, color: '#3f3b2e', marginBottom: 18, boxSizing: 'border-box' }}
          />
          ...
          <button
            ...
            disabled={loading}
            style={{
              width: '100%', background: '#33324a', color: '#f3ecdc', fontWeight: 600, fontSize: 15,
        ...
        <div style={{ textAlign: 'center', fontSize: 13, color: '#8d8570' }}>
          {mode === 'signup' ? (
            <>Already have an account? <span onClick={() => setMode('login')} style={{ fontWeight: 600, color: '#33324a', cursor: 'pointer' }}>Log in</span></>
          ) : (
            <>Don&apos;t have an account? <span onClick={() => setMode('signup')} style={{ fontWeight: 600, color: '#33324a', cursor: 'pointer' }}>Sign up</span></>
          )}
        </div>
      </div>
    </div>
